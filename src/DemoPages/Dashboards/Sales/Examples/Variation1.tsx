...
import { faAngleUp, faArrowRight, faAngleDown, faDotCircle } from "@fortawesome/free-solid-svg-icons";
                            ...
                            <Col lg="6" xl="4">
                                <Card className="mb-3">
                                    ...
                                    <CardBody className="pt-2 pb-0">
                                        <h6 className="text-muted text-uppercase font-size-md opacity-9 mb-2 fw-normal">Authors</h6>
                                                        ...
                                                        <div className="widget-content p-0">
                                                            <div className="widget-content-wrapper">
                                                                ...
                                                                <div className="widget-content-left">
                                                                    ...
                                                                    <div className="widget-subheading mt-1 opacity-10">
                                                                        <div className="badge rounded-pill badge-dark">$7</div>
                                                                    </div>
                                                                </div>
                                                                <div className="widget-content-right">
                                                                    <div className="fsize-1 text-focus">
                                ...
                                <Card className="mb-3">
                                    ...
                                    <div className="widget-chart widget-chart2 text-start p-0">
                                        <div className="widget-chat-wrapper-outer">
                                            <div className="widget-chart-content widget-chart-content-lg">
                                                <div className="widget-chart-flex">
                                                    <div className="widget-title opacity-5 text-muted text-uppercase">Toshiba Laptops</div>
                                                </div>
                                                <div className="widget-numbers">
                                                    <div className="widget-chart-flex">
                                                        <div>
                                                            ...
                                                            <CountUp start={0} end={984} separator="" decimals={0} decimal="" prefix="$" duration={15} />
                                                        </div>
                                                        <div className="widget-title ms-2 font-size-lg fw-normal text-muted">
                                    ...
                                    <CardBody className="pt-2 pb-0">
                                        <h6 className="text-muted text-uppercase font-size-md opacity-9 mb-2 fw-normal">Top Performing</h6>
                                        <div className="scroll-area-md shadow-overflow">
                                            <PerfectScrollbar>
                                                <ListGroup className="rm-list-borders rm-list-borders-scroll" flush>
                                                    <ListGroupItem>
                                            ...
                                            <TabPane tabId="1">
                                                ...
                                                <ResponsiveContainer height={244}>
                                                    <BarChart data={data2}>
                                                        <XAxis dataKey="name" />
                                                        <Legend />
                                                        <Bar dataKey="Sales" stackId="a" fill="#30b1ff" />
                                                        <Bar dataKey="Downloads" stackId="a" fill="#30b1ff" fillOpacity=".15" />
                                                    </BarChart>
                                                </ResponsiveContainer>
                                            </TabPane>
                                            <TabPane tabId="2">
                        ...
                        <Row>
                            <Col md="12" lg="6" xl="8">
                                <Card className="mb-3">
                                    ...
                                    <CardBody>
                                        <DataTable data={data} columns={columns} pagination fixedHeader fixedHeaderScrollHeight="370px" />
                                    </CardBody>
                                </Card>
                            </Col>
                            <Col md="12" lg="6" xl="4">
