...
const CRMDashboard1 = () => {
  const [activeTab1, setActiveTab1] = useState<string>("11");
  const [activeTab2, setActiveTab2] = useState<string>("222");
  const [popoverOpen1, setPopoverOpen1] = useState<boolean>(false);
  const [popoverOpen2, setPopoverOpen2] = useState<boolean>(false);
  const [popoverOpen3, setPopoverOpen3] = useState<boolean>(false);
  const [popoverOpen4, setPopoverOpen4] = useState<boolean>(false);
  ...
  const togglePop2 = () => {
    setPopoverOpen2(!popoverOpen1);
  }

  const togglePop3 = () => {
    setPopoverOpen3(!popoverOpen1);
  }

  const togglePop4 = () => {
    setPopoverOpen4(!popoverOpen1);
  }
                ...
                <div className="btn-actions-pane-right">
                  <Button outline
                    className={
                      ...
                      classnames({ active: activeTab1 === "11" })
                    }
                    color="alternate"
                    onClick={() => {
                      toggle1("11");
                  ...
                  <Button outline
                    className={
                      ...
                      classnames({ active: activeTab1 === "22" })
                    }
                    color="alternate"
                    onClick={() => {
                      toggle1("22");
              ...
              <Table responsive hover striped borderless className="align-middle mb-0">
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="text-center">
                      <Button size="sm" color="primary" id={"PopoverCustomT-1"} onClick={togglePop1}>
                        Details
                      </Button>
                      <Popover className="popover-custom rm-pointers" placement="auto" isOpen={popoverOpen1}
                  ...
                  <tr>
                    ...
                    <td className="text-center">
                      <Button size="sm" color="primary" id={"PopoverCustomT-2"} onClick={togglePop2}>
                        Details
                      </Button>
                      <Popover className="popover-custom rm-pointers" placement="auto"
                        isOpen={popoverOpen2} target={"PopoverCustomT-2"} toggle={togglePop2}>
                        <PopoverBody>
                          <div className="dropdown-menu-header">
                            <div
                              className={classnames(
                  ...
                  <tr>
                    ...
                    <td className="text-center">
                      <Button size="sm" color="primary" id={"PopoverCustomT-3"} onClick={togglePop3}>
                        Details
                      </Button>
                      <Popover className="popover-custom rm-pointers" placement="auto"
                        isOpen={popoverOpen3} target={"PopoverCustomT-3"} toggle={togglePop3}>
                        <PopoverBody>
                          <div className="dropdown-menu-header">
                            <div
                              className={classnames(
                  ...
                  <tr>
                    ...
                    <td className="text-center">
                      <Button size="sm" color="primary" id={"PopoverCustomT-4"} onClick={togglePop4}>
                        Details
                      </Button>
                      <Popover className="popover-custom rm-pointers" placement="auto"
                        isOpen={popoverOpen4} target={"PopoverCustomT-4"} toggle={togglePop4}>
                        <PopoverBody>
                          <div className="dropdown-menu-header">
                            <div
                              className={classnames(
        ...
        <div className="text-center mb-3">
          ...
          <ButtonGroup size="lg" className="mb-3">
            <Button color="alternate btn-pill ps-3"
              className={
                "btn-shadow " +
                classnames({ active: activeTab1 === "1" })
              }>
              Hour
            </Button>
            <Button color="alternate"
              className={
                "btn-shadow " +
                classnames({ active: activeTab1 === "2" })
              }>
              Day
            </Button>
            <Button color="alternate"
              className={
                "btn-shadow " +
                classnames({ active: activeTab1 === "3" })
              }>
              Week
            </Button>
            <Button color="alternate btn-pill pe-3"
              className={
                "btn-shadow " +
                classnames({ active: activeTab1 === "4" })
              }>
              Month
            </Button>
          </ButtonGroup>
