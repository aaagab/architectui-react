                                    ...
                                    <div className="table-responsive">
                                        ...
                                        <div className="chat-wrapper">
                                            ...
                                            <div className="chat-box-wrapper">
                                                ...
                                                <div>
                                                    <div className="chat-box">Born and I will give you a complete account of the system.</div>
                                                    <small className="opacity-6">
                                                        <FontAwesomeIcon icon={faCalendarAlt} className="me-1" />
                                                        11:01 AM | Yesterday
                                                    </small>
                                                ...
                                                <div className="widget-content p-0">
                                                    <div className="widget-content-wrapper">
                                                        ...
                                                        <div className="widget-content-left">
                                                            ...
                                                            <div className="widget-subheading">Aenean vulputate eleifend tellus.</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </DropdownItem>
                                                ...
                                                <div className="widget-content p-0">
                                                    <div className="widget-content-wrapper">
                                                        ...
                                                        <div className="widget-content-left">
                                                            ...
                                                            <div className="widget-subheading">Vivamus elementum semper nisi.</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </DropdownItem>
                                                ...
                                                <div className="widget-content p-0">
                                                    <div className="widget-content-wrapper">
                                                        ...
                                                        <div className="widget-content-left">
                                                            ...
                                                            <div className="widget-subheading">Etiam sit amet orci eget eros faucibus</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </DropdownItem>
                                                ...
                                                <div className="widget-content p-0">
                                                    <div className="widget-content-wrapper">
                                                        ...
                                                        <div className="widget-content-left">
                                                            ...
                                                            <div className="widget-subheading">Lorem ipsum dolor sit amet, consectetuer</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </DropdownItem>
