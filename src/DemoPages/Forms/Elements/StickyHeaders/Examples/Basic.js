                            ...
                            <Card className="main-card mb-3">
                                <Sticky enabled={true} top=".app-header" innerZ="15" activeClass="sticky-active-class">
                                    <CardHeader className="card-header-lg">
                                        <div className="card-header-title font-size-lg text-capitalize fw-normal">Sticky Page Headers</div>
                                ...
                                <CardBody className="pt-4">
                                    <Col md="8" className="mx-auto">
                                        ...
                                        <FormGroup>
                                            ...
                                            <div>
                                                <FormGroup check>
                                                    <Input id="checkbox2" type="checkbox" /> <Label check>Check this custom checkbox</Label>
                                                </FormGroup>
                                                <FormGroup check>
                                                    <Input id="checkbox2" type="checkbox" /> <Label check>Or this one</Label>
                                                </FormGroup>
                                                <FormGroup check>
                                                    <Input id="checkbox2" type="checkbox" disabled /> <Label check>But not this disabled one</Label>
                                                </FormGroup>
                                            </div>
                                        </FormGroup>
                                        <FormGroup>
                                            ...
                                            <div>
                                                ...
                                                <FormGroup check disabled>
                                                    <Input disabled name="radio2" type="radio" /> <Label check>But not this disabled one</Label>
                                                </FormGroup>
                                            </div>
                                        </FormGroup>
                                        <FormGroup>
