...
import { Row, Col, Card, CardBody, CardTitle, FormGroup, Label, Input, Container } from "reactstrap";
                                            ...
                                            <Row>
                                                ...
                                                <Col md={4}>
                                                    <FormGroup>
                                                        ...
                                                        <DropdownList busy busySpinner={<FontAwesomeIcon className="text-success" spin icon="spinner" />} />
                                                    </FormGroup>
                                                </Col>
                                                <Col md={4}>
                                                    <FormGroup>
