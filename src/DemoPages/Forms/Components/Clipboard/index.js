...
import { Row, Col, Card, CardBody, FormText, CardTitle, Button, InputGroup, Input } from "reactstrap";
                            ...
                            <Col md="6">
                                <Card className="main-card mb-3">
                                    <CardBody>
                                        ...
                                        <textarea onChange={this.onChange} rows={2} cols={10} className="form-control" value={this.state.value} />
                                        {this.state.copied ? (
                                ...
                                <Card className="main-card mb-3">
                                    <CardBody>
                                        ...
                                        {this.state.copied ? <FormText color="success">Text has been copied.</FormText> : null}
                                    </CardBody>
                                </Card>
                            </Col>
                            <Col md="6">
