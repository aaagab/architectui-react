                            ...
                            <Col md="6">
                                <Card className="main-card mb-3">
                                    <CardBody>
                                        ...
                                        <div className="text-center">
                                            ...
                                            <div className="switch has-switch mb-2 me-2" data-on-label="ON" data-off-label="OFF" onClick={this.handleClick}>
                                                <div
                                                    className={cx("switch-animate", {
                                                        "switch-on": this.state.isToggleOn,
                                                        "switch-off": !this.state.isToggleOn,
                                ...
                                <Card className="main-card mb-3">
                                    <CardBody>
                                        ...
                                        <div className="text-center">
                                            <div
                                                className="switch has-switch has-switch-sm me-2 mb-2 me-2"
                                                data-on-label="ON"
                                                data-off-label="OFF"
                                                onClick={this.handleClick}
                                            >
                                            ...
                                            <div
                                                className="switch has-switch has-switch-sm mb-2 me-2"
                                                data-on-label="ON"
                                                data-off-label="OFF"
                                                onClick={this.handleClick}
                                            >
                                        ...
                                        <Row className="text-center">
                                            ...
                                            <Col md="6">
                                                ...
                                                <Switch
                                                    ...
                                                    id="material-switch"
                                                />
                                                <Switch onChange={this.handleChange} checked={this.state.checked} className="me-2 mb-2" id="normal-switch" />
                                            </Col>
                                        </Row>
