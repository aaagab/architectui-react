                            ...
                            <Col md="6">
                                ...
                                <Card className="main-card mb-3">
                                    <CardBody>
                                        ...
                                        />
                                        <Slider range min={0} max={100} defaultValue={[35, 65]} className="rc-slider-info rc-slider-line mb-2" />
                                        <Slider range min={0} max={100} defaultValue={[40, 60]} className="rc-slider-danger rc-slider-line rc-slider-sm mb-2" />
                                    </CardBody>
                                </Card>
                                <Card className="main-card mb-3">
                                    <CardBody>
                                        ...
                                        />
                                        <Slider range min={0} max={100} defaultValue={[35, 65]} className="rc-slider-success rc-slider-square mb-2" />
                                        <Slider
                                            range
                                            min={0}
                                            max={100}
