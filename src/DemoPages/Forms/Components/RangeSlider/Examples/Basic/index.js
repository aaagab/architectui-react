                            ...
                            <Col md="6">
                                ...
                                <Card className="main-card mb-3">
                                    <CardBody>
                                        ...
                                        <Slider range className="mb-2" disabled min={0} max={20} defaultValue={[3, 10]} tipFormatter={(value) => `${value}%`} />
                                    </CardBody>
                                </Card>
                            </Col>
                            <Col md="6">
                                <Card className="main-card mb-3">
                                    <CardBody>
                                        ...
                                        <Slider
                                            className="rc-slider-warning rc-slider-square rc-slider-lg mb-2"
                                            dots
                                            min={0}
                                            step={20}
                                            max={480}
                                        ...
                                        <Slider className="rc-slider-info mb-2" dots min={0} step={30} max={300} defaultValue={66} handleRender={handle} />
                                        <Slider
                                            range
                                            className="rc-slider-danger rc-slider-sm mb-2"
                                            dots
                                            step={40}
                                            min={0}
                                            max={360}
