...
import { AreaChart, Area, LineChart, Line, ResponsiveContainer, BarChart, Bar, ComposedChart, CartesianGrid, Tooltip } from "recharts";

import { faAngleUp, faArrowLeft, faArrowRight, faEllipsisH, faAngleDown } from "@fortawesome/free-solid-svg-icons";
                                    ...
                                    <div className="card mb-3 widget-chart widget-chart2 text-start">
                                        <div className="widget-chart-content">
                                            <div className="widget-chart-flex">
                                                ...
                                                <div className="widget-subtitle text-muted">Monthly Goals</div>
                                            </div>
                                            <div className="widget-chart-flex">
                                    ...
                                    <div className="card mb-3 widget-chart widget-chart2 text-start">
                                        <div className="widget-chart-content">
                                            <div className="widget-chart-flex">
                                                ...
                                                <div className="widget-subtitle text-muted">Bugs Fixed</div>
                                            </div>
                                            <div className="widget-chart-flex">
                                    ...
                                    <div className="card mb-3 widget-chart widget-chart2 text-start">
                                        <div className="widget-chart-content">
                                            <div className="widget-chart-flex">
                                                ...
                                                <div className="widget-subtitle text-success opacity-7">Solved</div>
                                            </div>
                                            <div className="widget-chart-flex">
                                                <div className="widget-numbers">
                                                    <CountUp
                                    ...
                                    <div className="card mb-3 widget-chart widget-chart2 text-start">
                                        <div className="widget-chat-wrapper-outer">
                                            <div className="widget-chart-content">
                                                <div className="widget-chart-flex">
                                                    <div className="widget-title">Profiles</div>
                                                    <div className="widget-subtitle text-muted">Active Users</div>
                                                </div>
                                                <div className="widget-chart-flex">
                                        ...
                                        <div className="widget-chat-wrapper-outer">
                                            <div className="widget-chart-content">
                                                <div className="widget-chart-flex">
                                                    ...
                                                    <div className="widget-subtitle text-muted">Successful</div>
                                                </div>
                                                <div className="widget-chart-flex">
                                                ...
                                                <div className="widget-numbers">
                                                    <div className="widget-chart-flex">
                                                        ...
                                                        <div className="widget-title ms-2 font-size-lg fw-normal text-dark">
                                                            <span className="opacity-5 text-muted pe-1">5%</span>
                                                            increase
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="widget-chart-flex">
                                                    <div className="widget-numbers">
                                                        <div className="widget-chart-flex">
                                                            ...
                                                            <div className="widget-title ms-2 opacity-5 font-size-lg text-muted">Total Sales</div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="card mb-3 widget-chart widget-chart2 text-start">
                                        <div className="widget-chat-wrapper-outer">
                                            <div className="widget-chart-content">
                                                <div className="widget-chart-flex">
                                                    <div className="widget-title">Payments</div>
                                                    <div className="widget-subtitle text-danger opacity-7">Failed</div>
                                                </div>
                                                <div className="widget-chart-flex">
                                                    <div className="widget-numbers text-success">
                                                        43
