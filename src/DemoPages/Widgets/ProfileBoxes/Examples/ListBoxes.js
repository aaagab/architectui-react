...
import { faAngleUp, faAngleDown, faDotCircle } from "@fortawesome/free-solid-svg-icons";
...
import { Row, Col, TabContent, TabPane, ButtonGroup, ListGroup, ListGroupItem, Card, CardBody, CardFooter } from "reactstrap";
                                                                    ...
                                                                    <div className="widget-content-right">
                                                                        <div className="icon-wrapper m-0">
                                                                            <div className="progress-circle-wrapper">
                                                                                <Progress type="circle" percent={62} width={54} />
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <ListGroupItem>
                                                            <div className="widget-content p-0">
                                                                <div className="widget-content-wrapper">
                                                                    ...
                                                                    <div className="widget-content-left flex2">
                                                                        <div className="widget-heading">Rosy O'Dowell</div>
                                                                        <div className="widget-subheading opacity-10">
                                                                            <span className="pe-2">
                                                    ...
                                                    <ListGroupItem>
                                                        <div className="widget-content p-0">
                                                            <div className="widget-content-wrapper">
                                                                ...
                                                                <div className="widget-content-left">
                                                                    <div className="widget-heading">Example file 2</div>
                                                                </div>
                                                                <div className="widget-content-right widget-content-actions">
                                                                    <Button size="sm" className="me-1 btn-icon btn-icon-only" color="primary">
                                                                        <i className="pe-7s-tools btn-icon-wrapper"> </i>
                                                ...
                                                <div className="widget-content p-0">
                                                    <div className="widget-content-wrapper">
                                                        ...
                                                        <div className="widget-content-left">
                                                            ...
                                                            <div className="widget-subheading">Lorem ipsum dolor</div>
                                                        </div>
                                                        <div className="widget-content-right">
                                                ...
                                                <div className="widget-content p-0">
                                                    <div className="widget-content-wrapper">
                                                        ...
                                                        <div className="widget-content-left">
                                                            ...
                                                            <div className="widget-subheading">Maecenas tempus, tellus</div>
                                                        </div>
                                                        <div className="widget-content-right">
                                                ...
                                                <div className="widget-content p-0">
                                                    <div className="widget-content-wrapper">
                                                        ...
                                                        <div className="widget-content-left">
                                                            ...
                                                            <div className="widget-subheading">Donec vitae sapien</div>
                                                        </div>
                                                        <div className="widget-content-right">
                                                ...
                                                <div className="widget-content p-0">
                                                    <div className="widget-content-wrapper">
                                                        ...
                                                        <div className="widget-content-left">
                                                            ...
                                                            <div className="widget-subheading">Curabitur ullamcorper ultricies</div>
                                                        </div>
                                                        <div className="widget-content-right">
                                            ...
                                            <ListGroupItem className="bg-warm-flame">
                                                <div className="widget-content p-0">
                                                    <div className="widget-content-wrapper">
                                                        ...
                                                        <div className="widget-content-left">
                                                            <div className="widget-heading text-dark opacity-7">March Totals</div>
                                                            <div className="widget-subheading opacity-10">
                                                                <span className="pe-2">
                                                    ...
                                                    <ListGroupItem>
                                                        <div className="widget-content">
                                                            <div className="text-center">
                                                                <h5 className="widget-heading opacity-4">March Totals</h5>
                                                                <h5>
                                                                    <span className="pe-2">
                                                                        <b className="text-danger">12</b> new leads,
                                                                    </span>
                                                ...
                                                <ListGroupItem>
                                                    <div className="widget-content p-0">
                                                        <div className="widget-content-wrapper">
                                                            ...
                                                            <div className="widget-content-left">
                                                                <div className="widget-heading">Katerina Hutchings</div>
                                                                <div className="widget-subheading">Group ArchitectUI</div>
                                                            </div>
                                                            <div className="widget-content-right">
                                                                <div className="font-size-xlg text-muted">
                                                                    <small className="opacity-5 pe-1">$</small>
                                                    ...
                                                    <div className="widget-content p-0">
                                                        <div className="widget-content-wrapper">
                                                            ...
                                                            <div className="widget-content-left">
                                                                ...
                                                                <div className="widget-subheading">Markets Planner</div>
                                                            </div>
                                                            <div className="widget-content-right">
                                                                <div className="font-size-xlg text-muted">
                                                                    <small className="opacity-5 pe-1">$</small>
                                ...
                                <Col md="12" lg="6" xl="4">
                                    ...
                                    <Card className="card-hover-shadow card-border mb-3">
                                        ...
                                        <CardBody>
                                            ...
                                            <p className="mb-0">Since the 1500s, when an unknown printer took a galley of type and scrambled.</p>
                                        </CardBody>
