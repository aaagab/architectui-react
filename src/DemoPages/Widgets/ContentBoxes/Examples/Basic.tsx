...
import { XAxis, Legend, ResponsiveContainer, BarChart, Bar, LineChart, Line, AreaChart, Area, Tooltip } from "recharts";

import { faEllipsisH, faAngleUp, faAngleDown, faDotCircle, faBars } from "@fortawesome/free-solid-svg-icons";
...
const dataD: ChartData<'doughnut'> = {
...
const BasicExample = () => {
    ...
    const [activeTab2, setActiveTab2] = useState<string>("111");
    const ref = useRef();
    const [data, setData] = useState<Array<number>>([boxMullerRandom()]);
    const [popoverOpen, setPopoverOpen] = useState<boolean>(false);

    useEffect(() => {
        const intervalId = setInterval(() => {
            let values = data.concat([boxMullerRandom()]);
            setData(values);
        }, 200);
        return () => {
    ...
    return (
        <Fragment>
            <TransitionGroup>
                <CSSTransition nodeRef={ref} component="div" classNames="TabsAnimation" appear={true} timeout={1500} enter={false} exit={false}>
                    <div>
                        <Row>
                            <Col md="12" lg="6">
                                <Card className="mb-3">
                                    <CardHeader className="card-header-tab">
                                        <div className="card-header-title font-size-lg text-capitalize fw-normal">Backlog Items</div>
                                    ...
                                    <CardBody>
                                        <TabContent activeTab={activeTab2}>
                                            <TabPane tabId="222">
                                                            ...
                                                            <div className="widget-chart-flex">
                                                                <div className="widget-numbers">
                                                                    <div className="widget-chart-flex">
                                                                        ...
                                                                        <div className="widget-title ms-2 opacity-5 font-size-lg text-muted">Total Leads</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <h6 className="text-muted text-uppercase font-size-md opacity-5 fw-normal">Top Authors</h6>
                                            ...
                                            <TabPane tabId="111">
                                                            ...
                                                            <div className="widget-chart-flex">
                                                                <div className="widget-numbers">
                                                                    <div className="widget-chart-flex">
                                                                        ...
                                                                        <div className="widget-title ms-2 opacity-5 font-size-lg text-muted">Sales</div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <h6 className="text-muted text-uppercase font-size-md opacity-5 fw-normal">Highlights</h6>
                                                                    ...
                                                                    <div className="widget-content-outer">
                                                                        <div className="widget-content-wrapper">
                                                                            <div className="widget-content-left">
                                                                                ...
                                                                                <div className="widget-subheading">What has been spent in total</div>
                                                                            </div>
                                                                            <div className="widget-content-right">
                                                                                <div className="widget-numbers text-muted">$234k</div>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
                            ...
                            <Col md="12" lg="6">
                                <Card className="mb-3">
                                    ...
                                    <CardBody className="p-0">
                                        ...
                                        <h6 className="text-muted text-uppercase font-size-md opacity-5 ps-3 pe-3 pb-1 fw-normal">Sales Progress</h6>
                                        <ListGroup flush>
                                ...
                                <Card className="mb-3">
                                    <CardHeader className="h-auto p-3">
                                        <div>
                                            ...
                                            <h6 className="menu-header-subtitle text-capitalize opacity-8">Live servers statistics</h6>
                                        </div>
                                        <div className="btn-actions-pane-right">
                                            <Button size="sm" onClick={togglePop} id="PopoverEx1" className="btn-icon btn-icon-only" color="dark">
                                                <div className="btn-icon-wrapper">
                                                    <FontAwesomeIcon icon={faBars} />
                                                </div>
                                            </Button>
                                        ...
                                        <Row>
                                            ...
                                            <Col md="8">
                                                <div className="chart-wrapper">
                                                    <ResponsiveContainer height={250}>
                                                        <Sparklines height={90} data={data} limit={30}>
                                                            <SparklinesBars
                                                                style={{
                                                                    fill: "#41c3f9",
                                                                    fillOpacity: ".25",
                                        ...
                                        <TabContent activeTab={activeTab}>
                                            <TabPane tabId="1">
                                                ...
                                                <ResponsiveContainer height={210}>
                                                    <BarChart barGap="12" data={data2}>
                                                        <XAxis dataKey="name" />
                                                        <Legend />
                                                        <Bar dataKey="Sales" stackId="a" fill="#3f6ad8" />
                                                        <Bar dataKey="Downloads" stackId="a" fill="#e0f3ff" />
                                                    </BarChart>
                                                </ResponsiveContainer>
                                            </TabPane>
                                            <TabPane tabId="2">
                                    ...
                                    <CardBody>
                                        <Row>
                                            ...
                                            <Col md="8">
                                                <div className="chart-wrapper">
                                                    <ResponsiveContainer height={250}>
                                                        <BarChart barGap="55" data={data222}>
                                                            <Bar dataKey="Sales" stackId="a" fill="#58a90f" />
                                                            <Bar dataKey="Downloads" stackId="a" fill="#ecffda" />
                                                        </BarChart>
                                                    </ResponsiveContainer>
                                                </div>
                                            </Col>
                                    ...
                                    <CardBody>
                                        <TabContent activeTab={activeTab2}>
                                            ...
                                            <TabPane tabId="222">
                                                ...
                                                <h6 className="text-muted text-uppercase font-size-md opacity-5 fw-normal">Last Month Highlights</h6>
                                                <div className="scroll-area-sm">
                                                    <PerfectScrollbar>
                                                        <ListGroup className="rm-list-borders rm-list-borders-scroll" flush>
                                                            <ListGroupItem>
                                                ...
                                                <Col md="12" lg="3" className="align-self-center">
                                                    <div>
                                                        <div className="widget-chart p-0">
                                                            <div className="widget-chart-content">
                                                                <div className="widget-numbers fsize-3">12.31k</div>
                                                                <div className="widget-subheading pt-1">Product Views</div>
                                                            </div>
                                                        </div>
                                                        <div className="divider" />
                                                        <div className="widget-chart p-0">
                                                            <div className="widget-chart-content">
                                                                <div className="widget-numbers fsize-3">$4.3M</div>
                                                                <div className="widget-subheading pt-1">Total Sales</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </Col>
                                                ...
                                                <Col sm="12" md="6" className="align-self-center">
                                                    <Row>
                                                        <Col sm="12" md="6">
                                                            <div className="widget-chart">
                                                                <div className="widget-chart-content">
                                                                    <div className="widget-numbers text-warning fsize-3">158</div>
                                                                    <div className="widget-subheading pt-1">Bug Reports</div>
                                                                </div>
                                                            </div>
                                                            <div className="divider" />
                                                            <div className="widget-chart">
                                                                <div className="widget-chart-content">
                                                                    <div className="widget-numbers text-success fsize-3">346</div>
                                                                    <div className="widget-subheading pt-1">Dropped Packages</div>
                                                                </div>
                                                            </div>
                                                        </Col>
                                                        <Col sm="12" md="6">
                                                            <div className="widget-chart">
                                                                <div className="widget-chart-content">
                                                                    <div className="widget-numbers text-info fsize-3">12.31k</div>
                                                                    <div className="widget-subheading pt-1">Page Views</div>
                                                                </div>
                                                            </div>
                                                            <div className="divider" />
                                                            <div className="widget-chart">
                                                                <div className="widget-chart-content">
                                                                    <div className="widget-numbers fsize-3">632</div>
                                                                    <div className="widget-subheading pt-1">Agents Online</div>
                                                                </div>
                                                            </div>
                                                        </Col>
                                                    </Row>
                                        ...
                                        <ListGroupItem>
                                            <Row>
                                                <Col md="6" className="align-self-center">
                                                    <Sparklines height={90} data={data} limit={150}>
                                                        <SparklinesBars
                                                            style={{
                                                                fill: "#41c3f9",
                                                                fillOpacity: ".25",
