                                            ...
                                            <VerticalTimeline layout="1-column" className="vertical-time-simple vertical-without-time">
                                                ...
                                                <VerticalTimelineElement className="vertical-timeline-item dot-success">
                                                    <h4 className="timeline-title">
                                                        Build the production release <div className="badge bg-danger ms-2">NEW</div>
                                                    </h4>
                                                </VerticalTimelineElement>
                                        ...
                                        <CardBody>
                                            ...
                                            <VerticalTimeline layout="1-column">
                                                ...
                                                >
                                                    ...
                                                    <p>
                                                        Lorem ipsum dolor sit amit,consectetur eiusmdd tempor incididunt ut labore et dolore magna elit enim at
