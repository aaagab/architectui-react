                    ...
                    <Row>
                        <Col md="12">
                            <Alert color="warning">
                                ...
                                <p className="mb-0">
                                    All Bootstrap 5 helper classes available in the official Bootstrap documentation are also available in ArchitectUI
                                    Framework: Spacing, resets, typography utilities, sizing and others.
                                </p>
                            </Alert>
                        </Col>
                        <Col lg="6">
