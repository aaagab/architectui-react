                                ...
                                <Col lg="6">
                                    <Card className="main-card mb-3">
                                        <CardBody>
                                            ...
                                            <Button className="mb-2 me-2" color="link">
                                                Link 1<span className="badge rounded-pill bg-primary">6</span>
                                            </Button>
                                            <Button className="mb-2 me-2" color="link">
                                                Link 2<span className="badge rounded-pill bg-success">6</span>
                                            </Button>
                                            <Button className="mb-2 me-2" color="link">
                                                Link 3<span className="badge rounded-pill bg-danger">6</span>
                                            </Button>
                                            <Button className="mb-2 me-2" color="link">
                                                Link 4<span className="badge rounded-pill bg-warning">6</span>
                                            </Button>
                                        </CardBody>
                                    </Card>
                                    <Card className="main-card mb-3">
                                        <CardBody>
                                            ...
                                            <Row className="text-center">
                                                <Col md="4">
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-sm bg-primary">Primary</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-sm bg-secondary">Secondary</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-sm bg-success">Success</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-sm bg-info">Info</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-sm bg-warning">Warning</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-sm bg-danger">Danger</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-sm bg-focus">Focus</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-sm bg-alternate">Alt</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-sm bg-dark">Dark</div>
                                                </Col>
                                                <Col md="4">
                                                ...
                                                <Col md="4">
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-lg bg-primary">Primary</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-lg bg-secondary">Secondary</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-lg bg-success">Success</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-lg bg-info">Info</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-lg bg-warning">Warning</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-lg bg-danger">Danger</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-lg bg-focus">Focus</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-lg bg-alternate">Alt</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-lg bg-dark">Dark</div>
                                                </Col>
                                            </Row>
                                            <div className="divider" />
                                            <Row>
                                                <Col md="12">
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-xl bg-primary">Primary</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-xl bg-secondary">Secondary</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-xl bg-success">Success</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-xl bg-info">Info</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-xl bg-warning">Warning</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-xl bg-danger">Danger</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-xl bg-focus">Focus</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-xl bg-alternate">Alt</div>
                                                    <div className="mb-2 me-2 badge badge-dot badge-dot-xl bg-dark">Dark</div>
                                                </Col>
                                            </Row>
                                        </CardBody>
                                    </Card>
                                    <Card className="main-card mb-3">
                                        <CardBody>
                                            ...
                                            <Button className="mb-2 me-2" color="link">
                                                Link 1<span className="badge bg-primary badge-dot badge-dot-lg"> </span>
                                            </Button>
                                            <Button className="mb-2 me-2" color="link">
                                                Link 2<span className="badge bg-success badge-dot badge-dot-lg"> </span>
                                            </Button>
                                            <Button className="mb-2 me-2" color="link">
                                                Link 3<span className="badge bg-danger badge-dot badge-dot-lg"> </span>
                                            </Button>
                                            <Button className="mb-2 me-2" color="link">
                                                Link 4<span className="badge bg-warning badge-dot badge-dot-lg"> </span>
                                            </Button>
                                        </CardBody>
                                    </Card>
                                    <Card className="main-card mb-3">
