// @flow strict
export const infiniteRect = { top: -Infinity, bottom: Infinity, height: Infinity, left: -Infinity, right: Infinity, width: Infinity };
...
export function isIntersecting(r1, r2, topOffset, bottomOffset) {
